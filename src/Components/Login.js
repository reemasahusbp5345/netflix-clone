  ...
  return (
    <div>
      ...
      <form
        ...
        className="absolute bg-black text-white left-0 right-0 w-1/3 mx-auto my-40 bg-opacity-80 p-12"
      >
        ...
        {!isSignInForm && (
          <input
            className="bg-gray-700 w-full rounded-lg p-4 my-4"
            ref={name}
            type="text"
        ...
        <button
          className="bg-red-700 w-full rounded-lg p-4 my-4 font-bold text-xl"
          onClick={handleForm}
        >
          {isSignInForm ? "Sign In" : "Sign Up"}
        </button>
